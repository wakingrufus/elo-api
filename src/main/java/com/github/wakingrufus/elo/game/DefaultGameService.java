...
public class DefaultGameService implements GameService {
    ...
    @Inject
    public DefaultGameService(GameDao gameDao,LeagueService leagueService,
    ...
    public void recalculateLeagueGames(League league) {
        ...
        List<Game> gamesForLeague = getGamesForLeague(league.getId());
    ...
    @Override
    public List<Game> getGamesForLeague(String leagueId) {
        League league = leagueService.getLeague(leagueId);
        return gameDao.byLeague(league.getId()).stream().map(GameRecord::toDto).collect(Collectors.toList());
    }
    ...
    public Game getById(String id) {
        Game game = null;
        GameRecord gameRecord = gameDao.findOne(id);
        if (gameRecord != null) {
